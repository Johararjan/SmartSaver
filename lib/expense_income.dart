...
import 'package:image_picker/image_picker.dart';// Import image_picker package
                ...
                Container(
                  ...
                  child: DropdownButtonFormField<String>(
                    ...
                    onChanged: (String? value) {
                      setState(() {
                        selectedCategory = value ?? "Housing"; // Update the selected category
                      });
                    },
                    decoration: InputDecoration(
                      labelText: "Category",
                  ...
                  onPressed: () async {
                    ...
                    if (user != null) {
                      ...
                      try {
                        ...
                        final DatabaseReference userRef = databaseReference.child('expenses/online/${user.uid}');
  ...
  class _TransactionsQueueState extends State<TransactionsQueue> {
    ...
    Future<void> fetchAndProcessSMS() async {
      ...
      final DateTime tenDaysAgo = DateTime.now().subtract(Duration(days: 10));
  ...
  String extractAmount(String text) {
    ...
    final debitKeywords = ["debit", "debited", "spent", "withdraw"];
    ...
    for (final keyword in debitKeywords) {
      ...
      if (keywordIndex != -1) {
        ...
        final amountSubstring = lowercaseText.substring(
                  ...
                  child: Column(
                    children: [
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        onChanged: (String? value) {
                          setState(() {
                            selectedCategories[index] = value; // Update the selected category
                          });
                        },
                        decoration: InputDecoration(
                          labelText: "Category",
            ...
            onPressed: () async {
              ...
              if (user != null) {
                ...
                for (int i = 0; i < transactions.length; i++) {
                  ...
                  final DatabaseReference userRef = databaseReference.child(
                      'expenses').child('online').child(user.uid);
                  final DatabaseReference newTransactionRef = userRef.push();
  ...
  class _CashTransactionFormState extends State<CashTransactionForm> {
    ...
    Future<void> _handleSubmit() async {
      ...
      if (user != null) {
        ...
        final DatabaseReference databaseReference = FirebaseDatabase.instance.reference();
        final newExpenseRef = databaseReference.child('expenses').child('cash').child(userUid).push();
